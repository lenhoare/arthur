...
const restoreElement = (
  ...
  // Preserve early prototype documents while retiring their marker URLs.
  if (
    getStoredComponent(element) &&
    element.link?.startsWith("https://arthur.invalid/component/")
  ) {
    element = {
      ...element,
      link: null,
      ...
      strokeColor:
        element.strokeColor === "transparent" ? "#474637" : element.strokeColor,
    };
  }
...
export const restoreAppState = (
  ...
  return {
    ...
    componentSessionId: defaultAppState.componentSessionId,
